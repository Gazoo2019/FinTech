...
Be sure to remind students that the invitation should be sent to the e-mail associated with the Github account and that invitations won't show up on the Github website, but need to be accessed via e-mail (click on link in invite in the e-mail).
...
Now the students are familiar with the basics of collaboration using Git, they can use these skills in the case study.
