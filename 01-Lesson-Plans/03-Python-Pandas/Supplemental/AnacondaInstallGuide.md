...
* **NOTE:** In this course, we will create and use a virtual environment that uses Python 3.10. Be sure to follow our instructions for creating the virtual environment and activate the environment before you run any code.
